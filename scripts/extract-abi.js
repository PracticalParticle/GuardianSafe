...
const contractsToProcess = ['MultiPhaseSecureOperation', 'SecureOwnable', 'DynamicRBAC', 'GuardianAccountAbstraction', 'GuardianAccountAbstractionWithRoles', 'SimpleVault', 'SimpleRWA20'];
